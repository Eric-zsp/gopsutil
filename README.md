...
[![Test](https://gits.joyconn.cn/go-eric/gopsutil/actions/workflows/test.yml/badge.svg)](https://gits.joyconn.cn/go-eric/gopsutil/actions/workflows/test.yml) [![Coverage Status](https://coveralls.io/repos/github/shirou/gopsutil/badge.svg?branch=master)](https://coveralls.io/github/shirou/gopsutil?branch=master) [![Go Reference](https://pkg.go.dev/badge/gits.joyconn.cn/go-eric/gopsutil/v3.svg)](https://pkg.go.dev/gits.joyconn.cn/go-eric/gopsutil/v3) [![Go Documentation](https://godocs.io/gits.joyconn.cn/go-eric/gopsutil/v3?status.svg)](https://godocs.io/gits.joyconn.cn/go-eric/gopsutil/v3) [![Calendar Versioning](https://img.shields.io/badge/calver-vMAJOR.YY.MM-22bfda.svg)](https://calver.org/)
...
There are some breaking changes. Please see [v4 release note](https://gits.joyconn.cn/go-eric/gopsutil/releases/tag/v4.24.5).
...
As of v3.23.6, it is now possible to pass a path location using `context`: import `"gits.joyconn.cn/go-eric/gopsutil/v3/common"` and pass a context with `common.EnvMap` set to `common.EnvKey`, and the location will be used within each function.
...
Be very careful that enabling the cache may cause inconsistencies. For example, if you enable caching of boottime on Linux, be aware that unintended values may be returned if [the boottime is changed by NTP after booted](https://gits.joyconn.cn/go-eric/gopsutil/issues/1070#issuecomment-842512782).
...
See https://pkg.go.dev/gits.joyconn.cn/go-eric/gopsutil/v4 or https://godocs.io/gits.joyconn.cn/go-eric/gopsutil/v4
